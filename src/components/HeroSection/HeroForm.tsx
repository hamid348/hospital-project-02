    ...
    <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md">
      <form className="flex flex-col gap-6">
        ...
        <div className="mb-5">
          ...
          <select
            id="countries"
            className="w-full p-2.5 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500"
          >
